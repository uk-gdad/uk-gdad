...
2. **Mirroring** — the five derived projects hold exactly the canonical set.
...
| `levels are numbered [1, 2, 4]` | A gap after a deletion | Renumber, in all six projects |
...
That diff is exactly what moved, and it is the work list for the other five
projects.
