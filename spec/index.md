...
| ---------------------- | ------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Start here             | `# <Level> - start here`                                      | Start here · Purpose · Learning pathway                                                                                                                                                                                                      |
...
[`bin/make-github-pages`](../bin/make-github-pages) publishes the site, and
`make github-pages` does the same thing as a Makefile task: it runs
`bin/check`, then
