...
other three role projects mirror it. Adding a file here without adding the
matching file to the other three breaks `bin/check`.
...
4. Create the matching file in the other three projects, or record why not.
